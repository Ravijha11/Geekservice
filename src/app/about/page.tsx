...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col bg-white">
      {/* Who We Are Section */}
      <section className="py-8 sm:py-16 bg-white flex flex-col md:flex-row items-center gap-8 sm:gap-12 px-2 sm:px-4 max-w-7xl mx-auto w-full">
        <div className="flex-1 flex flex-col items-start justify-center">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 font-serif text-left">Who we are?</h1>
          <p className="mb-4 sm:mb-6 text-base sm:text-lg font-serif text-left max-w-2xl">
            Geek Services is a comprehensive tech and appliance support service provider that caters to a wide range of electronic devices and appliances. Specializing in services for Computers &amp; Tablets, Mobile Devices, Printers, WiFi &amp; Networking, TV &amp; Home Theater, Video Games &amp; Entertainment, Cameras &amp; Camcorders, Smart Home, Home Security, Drones, Audio &amp; Video, TV Mounting, Major Appliances, Small Appliances, and more, Geek Services aims to address the diverse support service needs of its customers.
          </p>
          <p className="mb-4 sm:mb-6 text-base sm:text-lg font-serif text-left max-w-2xl">
            One notable feature of Geek Services is their commitment to prompt and efficient service. Customers can conveniently book appointments for support, installations, troubleshooting, or device pickups. The company&apos;s experts are equipped with the knowledge and skills to swiftly diagnose and address a wide array of tech-related issues, ensuring that customers can get back to using their devices without unnecessary delays.
          </p>
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4 font-serif text-left">About Us</h2>
          <p className="mb-4 sm:mb-6 text-base sm:text-lg font-serif text-left max-w-2xl">
            Geek Services also emphasizes the importance of keeping customers connected. In addition to support services, they offer protection plans to safeguard devices from potential damage. Whether it&apos;s a cracked screen on a mobile device, a malfunctioning appliance, or a networking issue, Geek Services strives to provide comprehensive solutions that cover the entire spectrum of tech and appliances care.
          </p>
